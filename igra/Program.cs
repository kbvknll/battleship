    ...
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            while (exit != true)
            {
                ...
                Console.WriteLine("Спасибо за игру! Сыграем еще раз? (да / нет)");
    ...
    public class User : Battleship
    {
        public User()
        {
            ...
            else
            {
                ...
                if (Console.ReadLine() != "да")
                    hor = false;
                Four(Convert.ToInt32(Console.ReadLine()), Convert.ToInt32(Console.ReadLine()), false, hor);
                Console.Clear();
                while (Number < three)
                {
                    Three();
        ...
        private void Four(int x1, int y1, bool rand, bool Horiz)
        {
